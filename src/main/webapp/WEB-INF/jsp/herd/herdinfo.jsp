...
<section id="mainContent" style="text-align: center;">
  <form id="addAnimalPage" name="herdForm" action="/herd/herdSubmit" enctype="multipart/form-data" method="post">
    <div class="aTitle">
      ...
      <input type="text" name="id" id="id" value="${herd.id}" style="pointer-events: none;" hidden>
    </div>
    <div class="aType">
    ...
    <div class="aID">
      <table class="herdTableForm">
        <tbody>
          ...
          <tr>
            <td>
              <input type="text" name="animalId1" id="animalId1" onfocusout="validateAnimalId1()" value="${herd.animalId1}">
            </td>
            <td>
              <input type="text" name="animalId2" id="animalId2" value="${herd.animalId2}">
            </td>
          </tr>
          ...
          <tr>
            <td>
              <input type="text" name="breed" id="breed" onfocusout="validateBreed()" value="${herd.breed}">
            </td>
            <td>
              <div>
          ...
          <!-- This row will be used for error checking -->
          <td>
            <div id="errorBreed" style="color: red;">
    ...
    <div class="aDates">
      <table class="herdTableForm">
        <tbody>
          ...
          <tr>
            <td>
              <input type="date" name="dateOfBirth" id="dateOfBirth" value="${herd.dateOfBirth}">
            </td>
            <td>
              <input type="date" name="dateOfDeath" id="dateOfDeath" value="${herd.dateOfDeath}">
            </td>
          </tr>
        </tbody>
      </table>
  ...
  <div class="CalfListOnHerd">
    ...
    <table style="background-color: rgba(129,129,129,0.47); border-radius: 15px;">
      ...
      <tbody>
        ...
        <tr>
          <td>
            <a href="./calfUpdate?calfId=${calfList.calf.id}">
              <button>Edit</button>
            </a>
          </td>
