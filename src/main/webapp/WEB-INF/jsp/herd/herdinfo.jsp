    ...
    <form id="addAnimalPage" name="herdForm" action="/herd/herdSubmit" enctype="multipart/form-data" method="post">
        ...
        <div class="aID">
            <table class="herdTableForm">
                ...
                <tr>
                    <td><input type="text" name="animalId1" id="animalId1" onfocusout="validateAnimalId1()"
                               value="${herd.animalId1}"></td>
                ...
                <tr>
                    <td><input type="text" name="breed" id="breed" onfocusout="validateBreed()" value="${herd.breed}">
                    </td>
                    <td>
                        <div>
                ...
                <tr class="errorJSChecking">
                    <!-- This row will be used for error checking -->
                    <td>
                        <div id="errorBreed" style="color: red;"><c:forEach
                                items='${bindingResult.getFieldErrors("breed")}'
                                var="error">${error.getDefaultMessage()}</c:forEach></div>
                    </td>
                    <td></td>
                </tr>
                </tbody>
